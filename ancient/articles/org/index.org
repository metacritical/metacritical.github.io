...
#+HTML_HEAD: <link id="pagestyle" rel="stylesheet" type="text/css" href="assets/css/org.css"/>
#+HTML_BODY: <script id="dsq-count-scr" src="selfdotsend.disqus.com/count.js" async></script>
#+OPTIONS: toc:nil num:3 H:4 ^:nil pri:t

* Articles
- [[file:./pages/rubyinterviewquestions.org][Some Ruby/Rails Interview Questions I asked.]]
- Developing a Scheme Interpreter in C.
- [[file:./pages/gtd.org][Doing GTD in org mode.]]
 
* Projects
- Writing a Text Editor in Golang.
* Thought Experiments.

#+INCLUDE: ../../assets/disqus.org
