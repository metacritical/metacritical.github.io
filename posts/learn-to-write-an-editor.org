...
#+TAGS:        editor, emacs, vim, scheme, writing an editor
#+LANGUAGE:    en
#+OPTIONS:     H:3 num:nil toc:nil \n:nil ::t |:t ^:nil -:nil f:t *:t <:t
#+DESCRIPTION: A series of Assays on writing a programmers editor.

#+ATTR_HTML: :alt Editorial illustration of a programmers editor assembled from modular layers
[[/assets/blog/2018/08/06/learn-to-write-an-editor/hero.png]]
...
undertertaking for an individual/ since companies like IntelliJ's entire business is
...
[[file:/assets/blog/2018/08/06/learn-to-write-an-editor/emacs-percentage-repo.png]]
...
[[file:/assets/blog/2018/08/06/learn-to-write-an-editor/vim-percentage-repo.png]]
