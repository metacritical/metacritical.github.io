...
#+ATTR_HTML: :alt Editorial illustration of Git states flowing through a branching Unix terminal workflow
[[/assets/blog/2018/07/19/git-status-on-unix-terminal/hero.png]]
...
[[file:/assets/blog/2018/07/19/git-status-on-unix-terminal/gits_normal.png]]

If git files are unstaged on the current path then it may look like this:

[[file:/assets/blog/2018/07/19/git-status-on-unix-terminal/gits_unstaged.png]]
