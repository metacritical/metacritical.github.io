...
<head>
  ...
  <style>
    ...
    .draft-plus-menu { display:none; flex-wrap:wrap; gap:6px; max-width:310px; padding:8px; background:#1f1f1f; border-radius:12px; box-shadow:0 12px 22px rgba(0,0,0,.2); margin-bottom:8px; }
