...
<div class=\"draft-plus\" id=\"draft-plus\">
  <div class=\"draft-plus-menu\" id=\"draft-plus-menu\">
    ...
    <button type=\"button\" data-action=\"source\" title=\"Source block\" aria-label=\"Source block\">
      <svg viewBox='0 0 24 24' aria-hidden='true'><text x='12' y='16' text-anchor='middle' font-size='11' fill='currentColor' font-weight='600'>SRC</text></svg>
    </button>
    <button type=\"button\" data-action=\"ditaa\" title=\"Ditaa diagram\" aria-label=\"Ditaa diagram\">
      <svg viewBox='0 0 24 24' aria-hidden='true'><text x='12' y='16' text-anchor='middle' font-size='11' fill='currentColor' font-weight='600'>DIA</text></svg>
    </button>
    <button type=\"button\" data-action=\"plantuml\" title=\"PlantUML diagram\" aria-label=\"PlantUML diagram\">
      <svg viewBox='0 0 24 24' aria-hidden='true'><text x='12' y='16' text-anchor='middle' font-size='11' fill='currentColor' font-weight='600'>UML</text></svg>
    </button>
    <button type=\"button\" data-action=\"ascii\" title=\"ASCII diagram\" aria-label=\"ASCII diagram\">
      <svg viewBox='0 0 24 24' aria-hidden='true'><text x='12' y='16' text-anchor='middle' font-size='11' fill='currentColor' font-weight='600'>ASC</text></svg>
    </button>
    <button type=\"button\" data-action=\"table\" title=\"Table\" aria-label=\"Table\">
      <svg viewBox='0 0 24 24' aria-hidden='true'><text x='12' y='17' text-anchor='middle' font-size='17' fill='currentColor' font-weight='600'>▦</text></svg>
    </button>
