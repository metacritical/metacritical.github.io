...
<head>
  ...
  <style>
    ...
    .draft-plus-menu button { width:44px; height:44px; border-radius:50%%; border:1px solid #36c9c7; background:#fff; color:#36c9c7; display:inline-flex; align-items:center; justify-content:center; padding:0; font-size:14px; }
