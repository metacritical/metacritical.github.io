...
<head>
  ...
  <style>
    ...
    .draft-plus-menu button { width:44px; height:44px; border-radius:50%%; border:1px solid #36c9c7; background:#fff; color:#1d1b18; display:inline-flex; align-items:center; justify-content:center; padding:0; font-size:14px; }
    .draft-plus-menu button svg { width:22px; height:22px; stroke:currentColor; fill:none; stroke-width:1.8; stroke-linecap:round; stroke-linejoin:round; }
...
<div class=\"draft-plus\" id=\"draft-plus\">
  <div class=\"draft-plus-menu\" id=\"draft-plus-menu\">
    ...
    <button type=\"button\" data-action=\"source\" title=\"Source block\" aria-label=\"Source block\">
      <svg viewBox='0 0 24 24' aria-hidden='true'><text x='12' y='16' text-anchor='middle' font-size='11' fill='currentColor' font-weight='400'>SRC</text></svg>
    </button>
    <button type=\"button\" data-action=\"ditaa\" title=\"Ditaa diagram\" aria-label=\"Ditaa diagram\">
      <svg viewBox='0 0 24 24' aria-hidden='true'><text x='12' y='16' text-anchor='middle' font-size='11' fill='currentColor' font-weight='400'>DIA</text></svg>
    </button>
    <button type=\"button\" data-action=\"plantuml\" title=\"PlantUML diagram\" aria-label=\"PlantUML diagram\">
      <svg viewBox='0 0 24 24' aria-hidden='true'><text x='12' y='16' text-anchor='middle' font-size='11' fill='currentColor' font-weight='400'>UML</text></svg>
    </button>
    <button type=\"button\" data-action=\"ascii\" title=\"ASCII diagram\" aria-label=\"ASCII diagram\">
      <svg viewBox='0 0 24 24' aria-hidden='true'><text x='12' y='16' text-anchor='middle' font-size='11' fill='currentColor' font-weight='400'>ASC</text></svg>
    </button>
    <button type=\"button\" data-action=\"table\" title=\"Table\" aria-label=\"Table\">
      <svg viewBox='0 0 24 24' aria-hidden='true'><text x='12' y='17' text-anchor='middle' font-size='17' fill='currentColor' font-weight='400'>▦</text></svg>
    </button>
