...
<head>
  ...
  <style>
    ...
    .draft-editable pre.code-block.syntax-theme-default .token.comment { color:#708090; }
    .draft-editable pre.code-block.syntax-theme-default .token.punctuation { color:#999; }
    .draft-editable pre.code-block.syntax-theme-default .token.property,
    .draft-editable pre.code-block.syntax-theme-default .token.tag,
    .draft-editable pre.code-block.syntax-theme-default .token.boolean,
    .draft-editable pre.code-block.syntax-theme-default .token.number,
    .draft-editable pre.code-block.syntax-theme-default .token.constant,
    .draft-editable pre.code-block.syntax-theme-default .token.symbol { color:#905; }
    .draft-editable pre.code-block.syntax-theme-default .token.selector,
    .draft-editable pre.code-block.syntax-theme-default .token.attr-name,
    .draft-editable pre.code-block.syntax-theme-default .token.string,
    .draft-editable pre.code-block.syntax-theme-default .token.char,
    .draft-editable pre.code-block.syntax-theme-default .token.builtin,
    .draft-editable pre.code-block.syntax-theme-default .token.inserted { color:#690; }
    .draft-editable pre.code-block.syntax-theme-default .token.operator,
    .draft-editable pre.code-block.syntax-theme-default .token.entity,
    .draft-editable pre.code-block.syntax-theme-default .token.url,
    .draft-editable pre.code-block.syntax-theme-default .language-css .token.string,
    .draft-editable pre.code-block.syntax-theme-default .style .token.string { color:#9a6e3a; background:hsla(0,0%%,100%%,.5); }
    .draft-editable pre.code-block.syntax-theme-default .token.atrule,
    .draft-editable pre.code-block.syntax-theme-default .token.attr-value,
    .draft-editable pre.code-block.syntax-theme-default .token.keyword { color:#07a; }
    .draft-editable pre.code-block.syntax-theme-default .token.function,
    .draft-editable pre.code-block.syntax-theme-default .token.class-name { color:#dd4a68; }
    .draft-editable pre.code-block.syntax-theme-default .token.regex,
    .draft-editable pre.code-block.syntax-theme-default .token.important,
    .draft-editable pre.code-block.syntax-theme-default .token.variable { color:#e90; }
    .draft-editable pre.code-block.syntax-theme-dark .token.comment { color:#997f66; }
    .draft-editable pre.code-block.syntax-theme-dark .token.punctuation { opacity:.7; }
    .draft-editable pre.code-block.syntax-theme-dark .token.property,
    .draft-editable pre.code-block.syntax-theme-dark .token.tag,
    .draft-editable pre.code-block.syntax-theme-dark .token.boolean,
    .draft-editable pre.code-block.syntax-theme-dark .token.number,
    .draft-editable pre.code-block.syntax-theme-dark .token.constant,
    .draft-editable pre.code-block.syntax-theme-dark .token.symbol { color:#d1939e; }
    .draft-editable pre.code-block.syntax-theme-dark .token.selector,
    .draft-editable pre.code-block.syntax-theme-dark .token.attr-name,
    .draft-editable pre.code-block.syntax-theme-dark .token.string,
    .draft-editable pre.code-block.syntax-theme-dark .token.char,
    .draft-editable pre.code-block.syntax-theme-dark .token.builtin,
    .draft-editable pre.code-block.syntax-theme-dark .token.inserted { color:#bce051; }
    .draft-editable pre.code-block.syntax-theme-dark .token.operator,
    .draft-editable pre.code-block.syntax-theme-dark .token.entity,
    .draft-editable pre.code-block.syntax-theme-dark .token.url,
    .draft-editable pre.code-block.syntax-theme-dark .language-css .token.string,
    .draft-editable pre.code-block.syntax-theme-dark .style .token.string,
    .draft-editable pre.code-block.syntax-theme-dark .token.variable { color:#f4b73d; }
    .draft-editable pre.code-block.syntax-theme-dark .token.atrule,
    .draft-editable pre.code-block.syntax-theme-dark .token.attr-value,
    .draft-editable pre.code-block.syntax-theme-dark .token.keyword { color:#d1939e; }
    .draft-editable pre.code-block.syntax-theme-dark .token.function { color:#fff; }
    .draft-editable pre.code-block.syntax-theme-dark .token.regex,
    .draft-editable pre.code-block.syntax-theme-dark .token.important { color:#e90; }
    .draft-editable pre.code-block.syntax-theme-monokai .token.comment { color:#75715e; }
    .draft-editable pre.code-block.syntax-theme-monokai .token.punctuation { color:#f8f8f2; }
    .draft-editable pre.code-block.syntax-theme-monokai .token.property,
    .draft-editable pre.code-block.syntax-theme-monokai .token.tag,
    .draft-editable pre.code-block.syntax-theme-monokai .token.constant,
    .draft-editable pre.code-block.syntax-theme-monokai .token.symbol,
    .draft-editable pre.code-block.syntax-theme-monokai .token.deleted { color:#f92672; }
    .draft-editable pre.code-block.syntax-theme-monokai .token.boolean,
    .draft-editable pre.code-block.syntax-theme-monokai .token.number { color:#ae81ff; }
    .draft-editable pre.code-block.syntax-theme-monokai .token.selector,
    .draft-editable pre.code-block.syntax-theme-monokai .token.attr-name,
    .draft-editable pre.code-block.syntax-theme-monokai .token.string,
    .draft-editable pre.code-block.syntax-theme-monokai .token.char,
    .draft-editable pre.code-block.syntax-theme-monokai .token.builtin,
    .draft-editable pre.code-block.syntax-theme-monokai .token.inserted { color:#a6e22e; }
    .draft-editable pre.code-block.syntax-theme-monokai .token.operator,
    .draft-editable pre.code-block.syntax-theme-monokai .token.entity,
    .draft-editable pre.code-block.syntax-theme-monokai .token.url,
    .draft-editable pre.code-block.syntax-theme-monokai .language-css .token.string,
    .draft-editable pre.code-block.syntax-theme-monokai .style .token.string,
    .draft-editable pre.code-block.syntax-theme-monokai .token.variable { color:#f8f8f2; }
    .draft-editable pre.code-block.syntax-theme-monokai .token.atrule,
    .draft-editable pre.code-block.syntax-theme-monokai .token.attr-value,
    .draft-editable pre.code-block.syntax-theme-monokai .token.keyword { color:#f92672; }
    .draft-editable pre.code-block.syntax-theme-monokai .token.function { color:#e6db74; }
    .draft-editable pre.code-block.syntax-theme-monokai .token.regex,
    .draft-editable pre.code-block.syntax-theme-monokai .token.important { color:#fd971f; }
    ...
    .draft-plus { position: fixed; z-index: 9998; display:none; align-items:center; gap:10px; pointer-events:auto; }
...
<div class=\"draft-plus\" id=\"draft-plus\">
  ...
  <div class=\"draft-plus-menu\" id=\"draft-plus-menu\">
    ...
    <button type=\"button\" data-action=\"source\" title=\"Source block\" aria-label=\"Source block\">
      <svg viewBox='0 0 24 24' aria-hidden='true'><text x='12' y='16' text-anchor='middle' font-size='9' fill='currentColor' font-weight='600'>SRC</text></svg>
    </button>
    <button type=\"button\" data-action=\"ditaa\" title=\"Ditaa diagram\" aria-label=\"Ditaa diagram\">
      <svg viewBox='0 0 24 24' aria-hidden='true'><text x='12' y='16' text-anchor='middle' font-size='9' fill='currentColor' font-weight='600'>DIA</text></svg>
    </button>
    <button type=\"button\" data-action=\"plantuml\" title=\"PlantUML diagram\" aria-label=\"PlantUML diagram\">
      <svg viewBox='0 0 24 24' aria-hidden='true'><text x='12' y='16' text-anchor='middle' font-size='9' fill='currentColor' font-weight='600'>UML</text></svg>
    </button>
    <button type=\"button\" data-action=\"ascii\" title=\"ASCII diagram\" aria-label=\"ASCII diagram\">
      <svg viewBox='0 0 24 24' aria-hidden='true'><text x='12' y='16' text-anchor='middle' font-size='9' fill='currentColor' font-weight='600'>ASC</text></svg>
    </button>
    <button type=\"button\" data-action=\"table\" title=\"Table\" aria-label=\"Table\">
      <svg viewBox='0 0 24 24' aria-hidden='true'><text x='12' y='17' text-anchor='middle' font-size='14' fill='currentColor' font-weight='600'>▦</text></svg>
    </button>
...
(function(){
  ...
  function appendParagraphIfNeeded(){
    ...
    if (!isTextElement(last) && last.tagName.toLowerCase() !== 'ul' && last.tagName.toLowerCase() !== 'ol'){
  ...
  const CODE_SYNTAX_THEMES = [['default', 'Default'], ['dark', 'Dark'], ['monokai', 'Monokai']];
  ...
  body.addEventListener('click', (e)=>{
    ...
    if (block && block.parentElement === body && !block.classList.contains('image-block') && !block.classList.contains('table-block')) {
      const t = block.tagName.toLowerCase();
      if (['p','h1','h2','h3','h4','h5','h6','blockquote','pre','ul','ol','hr'].includes(t)) {
        if (e.target === block) {
          if (e.shiftKey) {
            e.preventDefault();
